    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-[#c7d6e6] via-[#cfd9e8] to-[#d6c9e8] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <motion.div
          ...
          className="mt-14 bg-white/40 backdrop-blur-2xl rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.15)] p-10 md:p-16"
        >
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <motion.div
                ...
                className="relative mt-10 w-[330px]"
              >
            ...
            <motion.form
              ...
              className="bg-white/50 backdrop-blur-2xl rounded-3xl p-10 shadow-xl hover:shadow-2xl transition duration-500"
            >
